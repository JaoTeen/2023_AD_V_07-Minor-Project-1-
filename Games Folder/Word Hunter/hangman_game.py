...
pygame.display.set_icon(pygame.image.load("image.jpg"))
...
images = []
for i in range(14):
    image = pygame.image.load("assets\\hangman_images\\images\\hangman" + str(i) + ".png") 
    images.append(image)
...
def reset__game_again():
    ...
    image = pygame.image.load("assets\\hangman_images\\images\\hangman0.png") 
    images.append(image)    
